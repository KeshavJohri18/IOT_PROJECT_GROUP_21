...
# Respect any CUDA_VISIBLE_DEVICES set by the user; default to empty (CPU-only) to avoid forcing GPUs.
# This must be set BEFORE importing project modules that may import torch and initialize CUDA.
